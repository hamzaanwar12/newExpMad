  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        {/* **New: Check Credentials Button** */}
        {course.is_enrolled && course.course_progress === 100 && (
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  checkCredentialsButton: {
    backgroundColor: "#FFD700", // Gold color for prominence
    paddingVertical: 14,
    paddingHorizontal: 30,
    borderRadius: 8,
    alignItems: "center",
    marginTop: 16, // Added margin for spacing
    marginBottom: 32, // Optional: Additional bottom margin
  },
  checkCredentialsButtonText: {
